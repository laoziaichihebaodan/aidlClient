...
public class Resource {
    ...
    public static CmdBean[] beans = {
            ...
            new CmdBean(0x4003,"路径浏览模式",
                    Constant.IA_CMD_SET_ROUTE_VIEW_MODE),
            new CmdBean(0x4004,"导航播报频率",
